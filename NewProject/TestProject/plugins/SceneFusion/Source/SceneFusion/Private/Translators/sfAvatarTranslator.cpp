...
void sfAvatarTranslator::Initialize()
{
    ...
    m_onCameraMovedHandle = sfUnrealEventDispatcher::Get().OnCameraMove.AddRaw(this,
        &sfAvatarTranslator::OnCameraMoved);
...
void sfAvatarTranslator::CleanUp()
{
    ...
    sfUnrealEventDispatcher::Get().OnCameraMove.Remove(m_onCameraMovedHandle);
    DestroyAvatars();
}
