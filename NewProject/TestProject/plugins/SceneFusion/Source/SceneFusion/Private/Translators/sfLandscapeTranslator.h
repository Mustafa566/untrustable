...
private:
    ...
    /**
     * Hack to expose private members of FLandscapeTextureDataInfo declared in LandscapeEdit.h. This class declares
     * the same members and functions stubs in the same order.
     */
    struct FLandscapeTextureDataInfoHack
    {
        struct FMipInfo
        {
            void* MipData;
        ...
        FLandscapeTextureDataInfoHack(UTexture2D* InTexture, bool bShouldDirtyPackage) { };
        virtual ~FLandscapeTextureDataInfoHack() { };
        ...
        void* GetMipData(int32 MipNum) { return nullptr; }
    ...
    /**
     * @return  true if SyncLandscape is enabled and the object limit of landscape type is not 0.
     */
    bool ShouldSyncLandscape();
};
