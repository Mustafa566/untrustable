...
public:
    ...
    void Save()
    {
        ...
        configs.Add("SyncBlueprintGraph=" + FString(SyncBlueprintGraph ? "true" : "false"));
        ...
        try {
            ...
            for (FString& line : configs)
            {
                if (line.Split("=", &key, &value))
                {
                    ...
                    if (key.Equals("SyncBlueprintGraph"))
                    {
                        SyncBlueprintGraph = value == "true";
                        continue;
                    }
