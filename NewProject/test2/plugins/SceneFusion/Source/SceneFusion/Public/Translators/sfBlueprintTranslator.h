...
private:
    ...
    FDelegateHandle m_onAssetEditorOpenedHandle;
    ...
    /**
     * Called when a component property changes. Marks blueprint as structually modified.
     *
    ...
    /**
     * Called when one or more elements are added to a list property. Marks blueprint as structually modified.
     *
    ...
    /**
     * Called when one or more elements are removed from a list property. Marks blueprint as structually modified.
     *
     ...
     */
    void SendComponentChangesRecursive(
    ...
    /**
     * Called when an asset is opened in the editor. Uploads the asset if it is a blueprint.
     *
     * @param   UObject* asset
     */
    ...
    /**
     * @return  true if SyncBlueprint is enabled and the object limit of blueprint type is not 0.
     */
    bool ShouldSyncBlueprint();
};