...
{
    m_onMoveStartHandle = sfUnrealEventDispatcher::Get().OnMoveStart.AddRaw(this, &sfSelectionManager::OnMoveStart);
    m_onMoveEndHandle = sfUnrealEventDispatcher::Get().OnMoveEnd.AddRaw(this, &sfSelectionManager::OnMoveEnd);
    m_onActorMovedHandle = sfUnrealEventDispatcher::Get().OnActorMove.AddRaw(this, &sfSelectionManager::OnActorMoved);
}

void sfSelectionManager::Stop()
{
    sfUnrealEventDispatcher::Get().OnMoveStart.Remove(m_onMoveStartHandle);
    sfUnrealEventDispatcher::Get().OnMoveEnd.Remove(m_onMoveEndHandle);
    sfUnrealEventDispatcher::Get().OnActorMove.Remove(m_onActorMovedHandle);
