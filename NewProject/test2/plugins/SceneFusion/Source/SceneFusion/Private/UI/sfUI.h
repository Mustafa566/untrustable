...
private:
    ...
    FDelegateHandle m_onLoaderMissingAssetHandle;
    FDelegateHandle m_onLoaderRemoveMissingAssetHandle;
    FDelegateHandle m_onMissingAssetHandle;
    FDelegateHandle m_onRemoveMissingAssetHandle;
     ...
     * @return  TSharedRef<SDockTab>
     */
    TSharedRef<SDockTab> OnCreateSettingsTab(const FSpawnTabArgs& args);
};