...
namespace SceneFusion2 {
    ...
    public:
        ...
        /**
         * Cast this instance to an sfStringProperty shared pointer.
         *
         * @return  std::shared_ptr<sfStringProperty>
         */
        std::shared_ptr<sfStringProperty> AsString();
         ...
         *
         * @param   sfProperty::SPtr property to serialize.
         * @param   std::vector<uint8_t>& output to serialize to.
         */
        static void Serialize(sfProperty::SPtr property, std::vector<uint8_t>& output);

        /**
         * Deserializes a property.
         *
         * param    std::vector<uint8_t>& input - serialized property.
         * @return  sfProperty::SPtr deserialized property.
         */
        static sfProperty::SPtr Deserialize(std::vector<uint8_t>& input);
    };
} // SceneFusion2
} // KS