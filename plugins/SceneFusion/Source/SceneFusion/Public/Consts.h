...
public:
    ...
    static const sfName SyncBlueprintGraph;
    ...
    static const sfName MemberReference;
...
public:
    ...
    static const sfName UEdGraph;
    static const sfName UEdGraphNode;
    static const sfName UEdGraphPin;
};