...
void sfLevelTranslator::Initialize()
{
    ...
    m_onLayersChangedHandle = sfUnrealEventDispatcher::Get().OnLayersChange.AddRaw(this,
        &sfLevelTranslator::OnLayersChanged);
    m_onAddLevelToWorldHandle = sfUnrealEventDispatcher::Get().OnLevelAdd.AddRaw(this,
        &sfLevelTranslator::OnAddLevelToWorld);
    m_onPrepareToCleanseEditorObjectHandle = sfUnrealEventDispatcher::Get().OnPrepareToCleanseEditorObject.AddRaw(this,
        &sfLevelTranslator::OnPrepareToCleanseEditorObject);
    m_onWorldCompositionChangeHandle = sfUnrealEventDispatcher::Get().OnWorldCompositionChange.AddRaw(this,
        &sfLevelTranslator::SetWorldCompositionOnServer);
    m_onPackageMarkedDirtyHandle = sfUnrealEventDispatcher::Get().OnPackageDirty.AddRaw(this,
        &sfLevelTranslator::OnPackageMarkedDirty);
    m_onLevelDirtiedHandle = sfUnrealEventDispatcher::Get().OnLevelDirty.AddRaw(this,
        &sfLevelTranslator::OnLevelDirtied);
    m_onPropertyChangeHandle = sfUnrealEventDispatcher::Get().OnPropertyChange.AddRaw(this,
        &sfLevelTranslator::OnUPropertyChange);
    m_onTransformChangeHandle = sfUnrealEventDispatcher::Get().OnLevelTransformChange.AddLambda(
        [this](ULevel* levelPtr, const FTransform& transform)
    {
...
void sfLevelTranslator::CleanUp()
{
    ...
    sfUnrealEventDispatcher::Get().OnLayersChange.Remove(m_onLayersChangedHandle);
    sfUnrealEventDispatcher::Get().OnLevelAdd.Remove(m_onAddLevelToWorldHandle);
    sfUnrealEventDispatcher::Get().OnPrepareToCleanseEditorObject.Remove(m_onPrepareToCleanseEditorObjectHandle);
    sfUnrealEventDispatcher::Get().OnWorldCompositionChange.Remove(m_onWorldCompositionChangeHandle);
    sfUnrealEventDispatcher::Get().OnPackageDirty.Remove(m_onPackageMarkedDirtyHandle);
    sfUnrealEventDispatcher::Get().OnLevelDirty.Remove(m_onLevelDirtiedHandle);
    sfUnrealEventDispatcher::Get().OnPropertyChange.Remove(m_onPropertyChangeHandle);
    sfUnrealEventDispatcher::Get().OnLevelTransformChange.Remove(m_onTransformChangeHandle);
...
void sfLevelTranslator::RegisterPropertyChangeHandlers()
{
    ...
    m_propertyChangeHandlers[sfProp::Folder] = [this](UObject* uobjPtr, sfProperty::SPtr propertyPtr)
    {
        ...
        sfUnrealUtils::PreserveUndoStack([streamingLevelPtr, propertyPtr]()
        {
