...
void sfUndoManager::Initialize()
{
    ...
    m_onUndoHandle = sfUnrealEventDispatcher::Get().OnUndo.AddRaw(this, &sfUndoManager::OnUndo);
    m_onRedoHandle = sfUnrealEventDispatcher::Get().OnRedo.AddRaw(this, &sfUndoManager::OnRedo);
    m_beforeUndoRedoHandle = sfUnrealEventDispatcher::Get().BeforeUndoRedo.AddRaw(this,
        &sfUndoManager::BeforeUndoRedo);
}

void sfUndoManager::CleanUp()
{
    sfUnrealEventDispatcher::Get().OnUndo.Remove(m_onUndoHandle);
    sfUnrealEventDispatcher::Get().OnRedo.Remove(m_onRedoHandle);
    sfUnrealEventDispatcher::Get().BeforeUndoRedo.Remove(m_beforeUndoRedoHandle);
